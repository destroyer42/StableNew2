...
3. After accepted/integrated v2.6 release proof, establish the bounded
   post-v2.6 useful-output-efficiency baseline, then rewrite/authorize
   PR-IMG-100 from the exact integrated post-v2.6 parent.
