...
def check_webui_process():
    ...
    result = subprocess.run(
        [
            "powershell",
            "-Command",
            "Get-Process python | Where-Object {$_.CommandLine -like '*webui*'} | Select-Object Id,ProcessName,CPU,WorkingSet",
        ],
        capture_output=True,
        text=True,
    )
    ...
    result2 = subprocess.run(
        [
            "powershell",
            "-Command",
            "Get-Process python | Where-Object {$_.CommandLine -like '*webui*'} | Select-Object Id,Responding,Threads",
        ],
        capture_output=True,
        text=True,
    )
