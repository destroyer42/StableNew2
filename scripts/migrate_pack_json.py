...
def migrate_pack_json(json_path: Path) -> bool:
    ...
    try:
        ...
        if is_pack_data and not is_preset_data:
            ...
            unified = {"pack_data": data, "preset_data": {}}
            ...
            print("    Creating backup and attempting split...")
            ...
            unified = {"pack_data": pack_data, "preset_data": preset_data}
            print(
                f"    Split into pack_data (keys={list(pack_data.keys())}) and preset_data (keys={list(preset_data.keys())})"
            )
