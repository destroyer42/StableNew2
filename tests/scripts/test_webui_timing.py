...
def _probe_endpoint(endpoint, method="GET", json_data=None):
...
def main():
    ...
    for i in range(60):  # Test for 60 seconds
        models_status, models_resp = _probe_endpoint("/sdapi/v1/sd-models")
        options_status, options_resp = _probe_endpoint("/sdapi/v1/options")
        progress_status, progress_resp = _probe_endpoint("/sdapi/v1/progress")
        txt2img_status, txt2img_resp = _probe_endpoint("/sdapi/v1/txt2img", "POST", payload)
