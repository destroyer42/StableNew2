...
class TestSpinboxDarkModeStyle:
    ...
    def test_dark_spinbox_style_exists(self):
        ...
        root = _skip_if_no_tk()
        try:
            from src.gui.theme_v2 import apply_theme, DARK_SPINBOX_STYLE
...
class TestComboboxDarkModeStyle:
    ...
    def test_dark_combobox_style_exists(self):
        ...
        root = _skip_if_no_tk()
        try:
            from src.gui.theme_v2 import apply_theme, DARK_COMBOBOX_STYLE
            from tkinter import ttk
    ...
    def test_combobox_popup_dark_mode_options_set(self):
        ...
        root = _skip_if_no_tk()
        try:
            from src.gui.theme_v2 import apply_theme, BACKGROUND_ELEVATED, TEXT_PRIMARY
...
class TestEntryDarkModeStyle:
    ...
    def test_dark_entry_style_exists(self):
        ...
        root = _skip_if_no_tk()
        try:
            from src.gui.theme_v2 import apply_theme, DARK_ENTRY_STYLE
            from tkinter import ttk
...
class TestSliderValueLabelStyle:
    ...
    def test_slider_value_label_style_exists(self):
        ...
        root = _skip_if_no_tk()
        try:
            from src.gui.theme_v2 import apply_theme, SLIDER_VALUE_LABEL_STYLE
            from tkinter import ttk
...
class TestDarkLabelStyle:
    ...
    def test_dark_label_style_exists(self):
        ...
        root = _skip_if_no_tk()
        try:
            from src.gui.theme_v2 import apply_theme, DARK_LABEL_STYLE
            from tkinter import ttk
...
class TestCheckbuttonDarkModeStyle:
    ...
    def test_dark_checkbutton_style_exists(self):
        ...
        root = _skip_if_no_tk()
        try:
            from src.gui.theme_v2 import apply_theme, DARK_CHECKBUTTON_STYLE
            from tkinter import ttk
...
class TestScaleDarkModeStyle:
    ...
    def test_dark_scale_style_exists(self):
        ...
        root = _skip_if_no_tk()
        try:
            from src.gui.theme_v2 import apply_theme, DARK_SCALE_STYLE
            from tkinter import ttk
...
class TestButtonDarkModeStyle:
    ...
    def test_dark_button_style_exists(self):
        ...
        root = _skip_if_no_tk()
        try:
            from src.gui.theme_v2 import apply_theme, DARK_BUTTON_STYLE
            from tkinter import ttk
