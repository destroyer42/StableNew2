...
from src.randomizer import RandomizationSeedMode
...
class TestExpandConfigWithRandomizer:
    ...
    def test_determinism_with_seed(self) -> None:
        ...
        results1 = expand_config_with_randomizer(base, mode="fanout", max_variants=5, base_seed=42)
        results2 = expand_config_with_randomizer(base, mode="fanout", max_variants=5, base_seed=42)
