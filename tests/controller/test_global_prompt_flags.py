...
def test_global_prompt_flag_wiring():
    ...
    assert result_config["pipeline"]["apply_global_positive_txt2img"], (
        "Global positive should be enabled"
    )
    ...
    assert not result_config["pipeline"]["apply_global_positive_txt2img"], (
        "Global positive should be disabled"
    )
    assert result_config["pipeline"]["apply_global_negative_txt2img"], (
        "Global negative should be enabled"
    )
    ...
    assert not result_config["pipeline"]["apply_global_negative_txt2img"], (
        "Global negative should be disabled"
    )
