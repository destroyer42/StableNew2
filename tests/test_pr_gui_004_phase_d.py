...
def test_phase_d_integration():
    ...
    print("Summary:")
    print(
        f"  [OK] Parser: {len(components.loras)} LoRAs, {len(components.positive_embeddings) + len(components.negative_embeddings)} embeddings"
    )
    print("  [OK] JSON save: All fields serialized correctly")
    print("  [OK] TXT export: Pipeline syntax correct")
    print("  [OK] Reload: All fields preserved")
    print()
