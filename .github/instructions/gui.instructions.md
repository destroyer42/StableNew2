...
- **File placement**: `src/gui/` is the active Tk runtime; `src/gui_v2/` is toolkit-agnostic adapters only (no Tk imports). See `docs/Subsystems/GUI/GUI_Ownership_Map_v2.6.md` for full placement rules.
