...
### Testing
- Test file: `tests/gui_v2/test_pr_005_006.py`
- All tests passing ✓
...
### Testing
- Test file: `tests/gui_v2/test_pr_008.py`
- All tests passing ✓
- Verified:
...
### tests/gui_v2/test_pr_005_006.py
```
...
1. `tests/gui_v2/test_pr_005_006.py` (189 lines - comprehensive test suite)
2. `tests/gui_v2/test_pr_008.py` (327 lines - comprehensive test suite)
