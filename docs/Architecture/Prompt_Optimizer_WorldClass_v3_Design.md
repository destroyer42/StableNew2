...
- `docs/Research Reports/deep-research-report-prompt-optimization-world-class.md`
- `docs/Research Reports/StableNew2 Prompt Optimizer Deep Research_ World‑Class, Safe, Intent‑Aware, Policy‑Driven.pdf`
