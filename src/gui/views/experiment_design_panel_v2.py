# Renamed from experiment_design_panel.py to experiment_design_panel_v2.py
# ...existing code...
...
class ExperimentDesignPanel(ttk.Frame):
	...
	def __init__(self, master: tk.Misc, learning_controller: LearningController | None = None, *args: Any, **kwargs: Any) -> None:
...
ExperimentDesignPanel = ExperimentDesignPanel
